...
if saveon
	...
	Beta = f_EvoDN_net(Population,parameters,select,savedir,y);
	copyfile([pwd '\deepRVEA\evaluate_obj.m'], savedir);
	eval(['save ' savedir '/' y '.mat Population select Beta parameters FunctionValue time'])
end
end
